  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
        ...
        >
          {/* Telegram */}
          <a href="https://t.me/violetta_nutrition" target="blank" className="flex flex-col items-center gap-2 px-6 py-3 bg-white/60 backdrop-blur-sm rounded-2xl border border-stone-100 hover:bg-white hover:shadow-lg transition-all cursor-pointer">
